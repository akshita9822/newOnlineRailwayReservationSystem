...
public class TrainStation {
	...
	public TrainStation(int stationId, String trainFrom, String trainTo, String departureTime, String arrivalTime,
			int journeyFare, Integer trainNo) {
		super();
		this.stationId = stationId;
		this.trainFrom = trainFrom;
		this.trainTo = trainTo;
	...
	public String toString() {
		return "TrainStation [stationId=" + stationId + ", trainFrom=" + trainFrom + ", trainTo=" + trainTo
				+ ", departureTime=" + departureTime + ", arrivalTime=" + arrivalTime + ", journeyFare=" + journeyFare
				+ ", trainNo=" + trainNo + "]";
	}
