...
public class TrainInfo {
	...
	public TrainInfo(Integer trainNo, String trainName, String trainStart, String trainEnd, Date trainDate,
			int totalSeats, int seatsAC, int seatsSL, int fareSL, int fareAC, int waitingSL, int waitingAC,
			List<String> stations) {
		super();
		this.trainNo = trainNo;
		this.trainName = trainName;
	...
	public String toString() {
		return "TrainInfo [trainNo=" + trainNo + ", trainName=" + trainName + ", trainStart=" + trainStart
				+ ", trainEnd=" + trainEnd + ", trainDate=" + trainDate + ", totalSeats=" + totalSeats + ", seatsAC="
				+ seatsAC + ", seatsSL=" + seatsSL + ", fareSL=" + fareSL + ", fareAC=" + fareAC + ", waitingSL="
				+ waitingSL + ", waitingAC=" + waitingAC + ", stations=" + stations + "]";
	}
